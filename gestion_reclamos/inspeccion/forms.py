...
class NuevaInspeccion(forms.Form):
    ...
    reclamos = ((1,""),(2, "01-293934-02"),(3, "00-297349-01"),(4,"00-283706-01"))
    especies = ((1,""),(2, "jacaranda"),(3, "ceibo"),(4,"lapacho"))
    trabajos = ((1,""),(2, "Poda integral 1"),(3, "Poda integral 2"),(4,"Poda integral 3"),(5,"Poda reductiva 1"),(6,"Poda reductiva 2"),(7,"Poda reductiva 4"),(8,"Tala"),(9,"Extracción"),(10,"Corte de raices"))
    urgencias = ((1,""),(2, "Alta"),(3, "Media"),(4,"Baja"))
    inspectores = ((1,""),(2, "Pep Guardiola"),(3, "Miguel conejito Alejandro"),(4,"Angela Merkel"))
    #---------------------------------------------------------------------------------------------------------------
    seleccion=((1,'No'),(2,'si'))
