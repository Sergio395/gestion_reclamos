...
class NuevoReclamo(forms.Form):
    ...
    medio = forms.ChoiceField(
        ...
        choices=Reclamo.MedioChoices.choices
    )
    fuente = forms.ChoiceField(
        ...
        choices=Reclamo.FuenteChoices.choices
    )
    ...
    reclamo = forms.ChoiceField(
        ...
        choices=Reclamo.ReclamoChoices.choices
    )
    urgencia = forms.ChoiceField(
        ...
        choices=Reclamo.UrgenciaChoices.choices
    )
