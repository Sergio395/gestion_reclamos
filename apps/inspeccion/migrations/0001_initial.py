    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('urgencia_trabajo', models.CharField(choices=[('BLANK ', ' '), ('BAJA', 'BAJA'), ('MEDIA', 'MEDIA'), ('ALTA', 'ALTA')], default='', max_length=10, verbose_name='Urgencia')),
                ...
                ('foto', models.ImageField(blank=True, null=True, upload_to='imagenes/', verbose_name='Fotos')),
                ('eliminado', models.BooleanField(default=False)),
                ('repitancia', models.CharField(default='', max_length=5, null=True, verbose_name='repitancia')),
                ('arbol', models.ForeignKey(blank='', null=True, on_delete=django.db.models.deletion.CASCADE, to='inspeccion.arbol', verbose_name='arbol')),
                ('especie', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='inspeccion.especies', verbose_name='Especie')),
                ('inspector', models.ForeignKey(blank='', null=True, on_delete=django.db.models.deletion.CASCADE, to='administracion.usuario', verbose_name='inspector')),
